    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            <ul class="list-group mb-3">
                ...
                @if($booking->user_check_in_date)
    <li><strong>Checked In At:</strong> {{ \Carbon\Carbon::parse($booking->user_check_in_date)->format('d M Y H:i') }}</li>
@endif
@if($booking->user_check_out_date)
    <li><strong>Checked Out At:</strong> {{ \Carbon\Carbon::parse($booking->user_check_out_date)->format('d M Y H:i') }}</li>
@endif
            </ul>
