...
<body>
  ...
  <main class="main-content" role="main">
        <section class="hotels-hero">
            <h1>Explore Zambia's Finest Accommodations</h1>
            <p>Discover luxury accommodations across Zambia's most beautiful destinations</p>
            
            <form action="{{ route('accommodation.index') }}" method="GET" class="hotel-search-box">
